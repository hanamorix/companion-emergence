...
- **She can leave you notes.** Turn it on (Connection panel → "Let `<her>` leave me notes") and when you've been away a while, she'll write you a note — a thought, a dream, something from your last talk — in a folder she picks for you in your Documents. She mentions it next time you talk. *(Experimental, off by default.)*

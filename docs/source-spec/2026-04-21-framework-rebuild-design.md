...
1. Read the current state of OG NellBrain at `/Users/hanamori/NellBrain/data/`
...
- **OG archive** lives at `/Users/hanamori/NellBrain-og/` (renamed and preserved) after switchover. Private forever.
...
- **Pre-tool hook**: block any write to `/Users/hanamori/NellBrain/` (the OG) except under a `--og-allowed` sentinel. The OG is maintenance-only during rebuild; this prevents accidental writes.
...
5. **T-35m**: OG repo archived: `mv /Users/hanamori/NellBrain /Users/hanamori/NellBrain-og`. OG directory is now read-only.
...
Rollback: if any step T-30 onward fails, restore `/Users/hanamori/NellBrain` from OG archive (renamed back), restart OG supervisor, resume on OG. Root-cause the failure in the new system before re-attempting.
...
- **OG**: the current NellBrain at `/Users/hanamori/NellBrain/` as of 2026-04-21
